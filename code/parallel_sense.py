...
def main() -> int:
    ...
    seed, experiment_filepath, hosts_filepath = (
        args.seed,
    ...
    optimizers = [
        mlos_core.optimizers.SmacOptimizer(
            max_trials=1000, seed=seed, parameter_space=input_space, n_random_init=500
        )
        for _ in hosts
    ]
    ...
    manager = ParallelWorkerManager(
        ...
        stopping_criteria=lambda iter, trial: iter < 1000,
